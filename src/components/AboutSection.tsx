              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 flex-wrap">
                  <button 
                    ...
                    className="group relative inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#25D366] text-white rounded-full hover:shadow-lg hover:bg-[#20BD5C] transition-all font-medium overflow-hidden transform hover:-translate-y-0.5"
                  >
                  ...
                  <button 
                    ...
                    className="group relative inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-[#833AB4] via-[#C13584] to-[#E1306C] text-white rounded-full hover:shadow-lg hover:from-[#C13584] hover:via-[#E1306C] hover:to-[#833AB4] transition-all font-medium overflow-hidden transform hover:-translate-y-0.5"
                  >
                    <span className="relative z-10 flex items-center gap-2">
                  ...
                  <button 
                    ...
                    className="group relative inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#EA4335] text-white rounded-full hover:shadow-lg hover:bg-[#D93025] transition-all font-medium transform hover:-translate-y-0.5"
                  >
                    <span className="relative z-10 flex items-center gap-2">
